...
<head>
<meta charset="UTF-8">
<title>2-9 연습문제 : 종합 문제1 - IPTV</title>
...
%>
	...
	<div id="wrap" class="container">
		...
		<section class="contents">
			<table class="table text-center">
				...
				for (Map<String, String> item : list) {
					// category를 뿌리는 조건(전체 : category가 null) 또는 (category가 map과 같을 때)
				...
				%>
					<tr>
						<td><%= item.get("ch") %></td>
						<td><%= item.get("name") %></td>
						<td><!-- <%= category %>:::::: --><%= item.get("category") %></td>
					</tr>
				<%	
					}
				}
		...
		<footer class="contensts bg-success d-flex justify-content-center align-items-center">
